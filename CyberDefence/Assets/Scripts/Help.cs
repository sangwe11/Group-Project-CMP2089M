...
public class Help : MonoBehaviour {
	void OnGUI(){
		...
		GUI.Label (new Rect (0.68f * Screen.width, 0.76f * Screen.height, 250, 120), "DDOS (Denial-of-Service) \nDDOS attacks are used to overwhelm a computer system or network with high amounts of traffic, with the intention to cause disruption or complete outage of the network.");
